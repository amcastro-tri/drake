...
class MultibodyPlant : public internal::MultibodyTreeSystem<T> {
 public:
  ...
  /// with size equal to the number of joint actuators in the model instance,
  /// times two (one configuration and one velocity). Entries in this vector
  /// corresponding to actuators without a PD controller are ignored.
  ///
  ...
  /// be connected.
  //
  // TODO: warn or throw if connected to a model with no PD control?. Right now
  // we do nothing.

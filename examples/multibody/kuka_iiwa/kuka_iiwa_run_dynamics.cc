...
using drake::multibody::benchmarks::kuka_iiwa_robot::MakeKukaIiwaPlant;
...
int do_main() {
  ...
  MultibodyPlant<double>& plant =
      *builder.AddSystem(MakeKukaIiwaPlant(true, &geometry_system));
  ...
  plant_context.FixInputPort(0, VectorX<double>::Zero(7));
...
int main(int argc, char* argv[]) {
  ...
  return drake::examples::multibody::kuka_iiwa::do_main();
}

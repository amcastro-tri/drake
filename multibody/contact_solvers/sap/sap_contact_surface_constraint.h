...
/* Structure to store data needed for SapContactSurfaceConstraint computations. */
template <typename T>
struct SapContactSurfaceConstraintData {
 public:
  DRAKE_DEFAULT_COPY_AND_MOVE_AND_ASSIGN(SapContactSurfaceConstraintData);

  /* Constructs data for a SapContactSurfaceConstraint.
  ...
  SapContactSurfaceConstraintData(const T& mu, const T& Rt, const T& Rn,
                                const T& vn_hat);
...
template <typename T>
class SapContactSurfaceConstraint final : public SapConstraint<T> {
 public:
  ...
  //@{
  SapContactSurfaceConstraint& operator=(const SapContactSurfaceConstraint&) =
      delete;
  SapContactSurfaceConstraint(SapContactSurfaceConstraint&&) = delete;
  SapContactSurfaceConstraint& operator=(SapContactSurfaceConstraint&&) = delete;
  //@}
  ...
  SapContactSurfaceConstraint(ContactConfiguration<T> configuration,
 ...
 private:
  /* Private copy construction is enabled to use in the implementation of
    DoClone(). */
  SapContactSurfaceConstraint(const SapContactSurfaceConstraint&) = default;
  ...
  std::unique_ptr<SapConstraint<T>> DoClone() const final {
    return std::unique_ptr<SapContactSurfaceConstraint<T>>(
        new SapContactSurfaceConstraint<T>(*this));
  }
  ...
  */
  ...
  void ProjectImpulse(const SapContactSurfaceConstraintData<T>& data,

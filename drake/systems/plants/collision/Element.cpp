...
Element::Element(const Isometry3d& T_element_to_local)
    : DrakeShapes::Element(T_element_to_local), id_(-1) {
}

Element::Element(const DrakeShapes::Geometry& geometry,
                 const Isometry3d& T_element_to_local)
    : DrakeShapes::Element(geometry, T_element_to_local), id_(-1) {
}

Element::Element(const Element& other)
    : DrakeShapes::Element(other), id_(-1) {}

Element* Element::clone() const { return new Element(*this); }

ElementId Element::id() const { return id_; }

void Element::set_id(int id) { id_ = id; }

...
struct PenetrationPatchPoint {
  ...
  /** Position vector for a point As on the surface of A measured and expressed
   in the world frame. */
  const Vector3<T> p_WoAs_W;

  /** Position vector for a point Bs on the surface of B (closest to the patch
   point `p_WoAs_W`) measured and expressed in the world frame. */
  ...
  /** The outward facing normal of mesh A at the patch point, expressed in the
   world frame.  */
